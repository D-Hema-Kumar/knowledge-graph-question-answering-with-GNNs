...
QUESTIONS_EMBEDDINGS_PATH = {
                                "roberta":"./data/question_embeddings/roberta",
                                "gpt2":"./data/question_embeddings/gpt2"
}
...
LM_EMBEDDINGS_PATH = {"roberta":"./data/graph_embeddings/roberta",
                      "gpt2":"./data/graph_embeddings/gpt2"
}
...
MetaQA_CONFIG = {"KB_PATH":"./data/MetaQA/source_data/kb.txt",
                "ENTITIES_LABELS_PATH":"./data/MetaQA/source_data/kb_entities.csv",
                 ...
                 "QUESTIONS_GPT2_EMBEDDINGS_1_HOP_TRAIN_PATH":"./data/MetaQA/question_embeddings/one-hop/train/gpt2",
                 ...
                 "QUESTIONS_GPT2_EMBEDDINGS_1_HOP_TEST_PATH":"./data/MetaQA/question_embeddings/one-hop/test/gpt2",
                 ...
                 "QUESTIONS_GPT2_EMBEDDINGS_2_HOP_TRAIN_PATH":"./data/MetaQA/question_embeddings/two-hop/train/gpt2",
                 ...
                 "QUESTIONS_GPT2_EMBEDDINGS_2_HOP_TEST_PATH":"./data/MetaQA/question_embeddings/two-hop/test/gpt2",
